...
class WxValidate {
    ...
    __initMethods() {
        ...
        that.methods = {
            ...
            letters(value) {
                return that.optional(value) || /^[a-z]+$/i.test(value)
            },
            time(value) {
                return that.optional(value) || /^([01]\d|2[0-3])(:[0-5]\d){1,2}$/.test(value)
            },
            qq(value) {
                return that.optional(value) || /^[1-9]\d{4,}$/.test(value)
            },
            tel(value) {
                return that.optional(value) || /^(?:(?:0\d{2,3}[\- ]?[1-9]\d{6,7})|(?:[48]00[\- ]?[1-9]\d{6}))$/.test(value)
            },
            zipcode(value) {
            ...
            username(value) {
                return that.optional(value) || /^\w{3,12}$/.test(value)
            },
            password(value) {
                return that.optional(value) || /^[\S]{6,16}$/.test(value)
            },
            // 结束 增加验证规则
            /**
             * 验证必填元素

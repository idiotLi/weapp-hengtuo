...
Page({
    ...
    onLoad: function (options) {
        this.setData({
            loginUsernameText: wx.getStorageSync('config')['loginUsernameText'] ? app.utils.towxml(wx.getStorageSync('config')['loginUsernameText']) : ''
        })
    ...
    onSubmit(e) {
        ...
        wx.request({
            url: app.baseURL + 'login/usernameLogin/',
            method: 'POST',
            timeout: 5000,
            header: {
                'Cookie': app.globalData.sessionId,
